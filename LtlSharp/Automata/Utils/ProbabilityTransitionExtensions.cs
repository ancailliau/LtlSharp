...
namespace LtlSharp.Automata.Utils
{
    public static class ProbabilityTransitionExtensions
    {
        ...
        public static void SetProbability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                      T source,
                                      T target,
                                      double value)
        ...
        /// <param name="source">Source.</param>
        /// <param name="target">Target.</param>
        public static double GetProbability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                        T source,
                                        T target)
            where T : IAutomatonNode
        {
        ...
        /// steps.</param>
        public static IDictionary<T, double> Reachability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                                      IEnumerable<T> B,
        ...
        /// <param name="n">Number of steps, if iterative resolution. Set to <c>-1</c> to not stop after <c>n</c> 
        /// steps.</param>
        public static IDictionary<T, double> ConstrainedReachability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                                                 IEnumerable<T> C,
                                                                 IEnumerable<T> B,
                                                                 bool iterative = false,
                                                                 double epsilon = 1e-5,
        ...
        static IEnumerable<T> ComputeS0<T>(Automaton<T, ProbabilityDecoration> mc,
                                    IEnumerable<T> C,
        ...
        static IEnumerable<T> ComputeS1<T>(Automaton<T, ProbabilityDecoration> mc,
                                    IEnumerable<T> C,
                                    IEnumerable<T> B) where T : IAutomatonNode
        {
            // For detailled discussion about the following algorithm, check "Principles of Model Checking", p767ff.
            var mcprime = (Automaton<T, ProbabilityDecoration>)mc.Clone ();
        ...
        /// <param name="mc">Markov Chain.</param>
        /// <param name="B">B.</param>
        public static IEnumerable<T> GlobalAlmostSureReachability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                                              IEnumerable<T> B) where T : IAutomatonNode
        {
        ...
        /// <param name="mc">Markov Chain.</param>
        /// <param name="B">B.</param>
        public static IEnumerable<T> QualitativeRepeatedReachability<T>(this Automaton<T, ProbabilityDecoration> mc,
                                                                 IEnumerable<T> B) where T : IAutomatonNode
        {
        ...
        /// <param name="mc">Mc.</param>
        /// <param name="B">B.</param>
        public static IDictionary<T, double> QuantitativeRepeatedReachability<T>(this Automaton<T, ProbabilityDecoration> mc,
        ...
        public static Dictionary<T, double> QuantitativeLinearProperty<T>(this Automaton<T, ProbabilityDecoration> mc,
                                                                   ITLFormula formula) where T : IAutomatonNode
        {
            // For more details, see "Principles of Model Checking", p785ff

            Automaton<ProductAutomatonNode<T, AutomatonNode>, ProbabilityDecoration> productMC;
        ...
        /// <summary>
        /// Returns the product automaton of the specified Markov Chain and the specified Buchï Automata.
        /// </summary>
        /// <description>
        /// This methods is used to compute the product automaton between a Markov Chain and a Buchï Automata.
        /// 
        /// A trace in the resulting automaton is accepting if it contains at least a state in <c>condition</c>.
        /// 
        ...
        /// automaton and <c>y</c> is the corresponding node in the specified Markov Chain for the initial state of 
        /// the Buchï Automata.</param>
        public static Automaton<ProductAutomatonNode<T, AutomatonNode>, ProbabilityDecoration> Product<T> (
            this Automaton<T, ProbabilityDecoration> mc,
        ...
        /// <summary>
        /// Returns the product automaton of the specified Markov Chain and the specified Rabin Automata.
        /// </summary>
        /// <description>
        /// This methods is used to compute the product automaton between a Markov Chain and a Rabin Automata.
        /// 
        /// A trace in the resulting automaton is accepting if it there is a pair in <c>conditions</c> such that
        ...
        static Automaton<ProductAutomatonNode<T1, T2>, ProbabilityDecoration> Product<T1, T2> (
            this Automaton<T1, ProbabilityDecoration> automaton1,
